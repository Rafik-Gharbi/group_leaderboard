    ...
    if (theme == MyThemeMode.light) {
      return lightBase.copyWith(
        ...
        appBarTheme: const AppBarTheme(
          ...
          titleTextStyle: AppFonts.x18Bold,
        ),
        ...
        checkboxTheme: const CheckboxThemeData(checkColor: WidgetStatePropertyAll(kNeutralColor100)),
        cardTheme: CardThemeData(color: kNeutralColor100),
      ...
      debugPrint('Error: Provided theme does not exist');
    }
